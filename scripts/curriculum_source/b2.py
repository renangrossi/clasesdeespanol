...
LESSONS = [
    {
        ...
        "content": {
            ...
            "rules": [
                {"heading": "a) Formación a partir del indefinido", "body": "<p>ellos hablaron &rarr; hablara-; ellos tuvieron &rarr; tuviera-; ellos fueron &rarr; fuera-; se añaden las terminaciones -a, -as, -a, -amos (con tilde), -ais, -an.</p>"},
                {"heading": "b) Concordancia de tiempos (pasado &rarr; imperfecto de subjuntivo)", "body": "<p><em>Quería que vinieras conmigo.</em> (quería: imperfecto de indicativo &rarr; vinieras: imperfecto de subjuntivo) <em>Dudaba que fuera verdad.</em></p>"},
    ...
    },
    {
        ...
        "content": {
            ...
            "rules": [
                {"heading": "a) Expresiones impersonales de certeza &rarr; indicativo", "body": "<p><em>es verdad que, es evidente que, está claro que, es seguro que</em> + indicativo: <em>Es evidente que ella tiene razón.</em></p>"},
                {"heading": "b) Expresiones impersonales de valoración/duda &rarr; subjuntivo", "body": "<p><em>es importante que, es una lástima que, es posible que, es raro que, más vale que</em> + subjuntivo: <em>Es una lástima que no puedas venir.</em></p>"},
                ...
                {"heading": "d) Negar la certeza convierte el indicativo en subjuntivo", "body": "<p><em>Es verdad que viene</em> (indicativo) &rarr; <em>No es verdad que venga</em> (subjuntivo, porque la negación elimina la certeza).</p>"},
            ],
            "examples": [
    ...
    },
    {
        ...
        "content": {
            ...
            "rules": [
                {"heading": "a) Relativas con antecedente conocido &rarr; indicativo", "body": "<p><em>Tengo un amigo que habla cinco idiomas.</em> (existe, lo conozco)</p>"},
                {"heading": "b) Relativas con antecedente desconocido/inexistente &rarr; subjuntivo", "body": "<p><em>Necesito un amigo que hable cinco idiomas.</em> (no sé si existe tal persona) <em>No hay nadie que sepa la respuesta.</em> (antecedente inexistente)</p>"},
    ...
    },
    {
        ...
        "content": {
            ...
            "rules": [
                {"heading": "a) Presente &rarr; imperfecto", "body": "<p>\"Estoy cansada\" &rarr; <em>Dijo que estaba cansada.</em></p>"},
                {"heading": "b) Pretérito &rarr; pluscuamperfecto", "body": "<p>\"Llegué tarde\" &rarr; <em>Me contó que había llegado tarde.</em></p>"},
                {"heading": "c) Futuro &rarr; condicional", "body": "<p>\"Vendré mañana\" &rarr; <em>Prometió que vendría al día siguiente.</em></p>"},
                {"heading": "d) Imperativo &rarr; imperfecto de subjuntivo", "body": "<p>\"Cierra la puerta\" &rarr; <em>Me pidió que cerrara la puerta.</em></p>"},
                {"heading": "e) Marcadores de tiempo y lugar", "body": "<p><em>hoy &rarr; ese día/aquel día, ayer &rarr; el día anterior, mañana &rarr; al día siguiente, aquí &rarr; allí, este &rarr; aquel.</em></p>"},
            ],
            "examples": [
        ...
        "exercises": [
            {"id": "b2ei2-fill", "type": "fill-blank", "title": "Transforma a Estilo Indirecto (Pasado)",
             "items": [
                {"id": "b2ei2a", "prompt": "Ana dijo: \"Vivo en Sevilla.\" &rarr; Ana dijo que ___ en Sevilla.", "answers": [["vivía"]], "options": ["vivía", "vive", "viviría"], "explanation": "Presente en la cita original retrocede a imperfecto con el verbo introductor en pasado."},
                {"id": "b2ei2b", "prompt": "Juan prometió: \"Llamaré mañana.\" &rarr; Juan prometió que ___ al día siguiente.", "answers": [["llamaría"]], "options": ["llamaría", "llama", "llamará"], "explanation": "Futuro en la cita original retrocede a condicional."},
             ]},
            {"id": "b2ei2-mc", "type": "multiple-choice", "title": "Elige la Transformación Correcta",
             "items": [
                {"id": "b2ei2c", "prompt": "\"Cierra la puerta\", dijo el profesor. &rarr; en estilo indirecto...", "options": ["Dijo que cerrara la puerta.", "Dijo que cierre la puerta.", "Dijo que cierra la puerta."], "answerIndex": 0, "explanation": "El imperativo se transforma en imperfecto de subjuntivo con el verbo introductor en pasado."},
             ]},
    ...
    },
    {
        ...
        "content": {
            ...
            "rules": [
                {"heading": "a) Formación (a partir del imperfecto de subjuntivo)", "body": "<p>Se sustituye -ra por -re: hablara &rarr; hablare; tuviera &rarr; tuviere; fuera &rarr; fuere.</p>"},
